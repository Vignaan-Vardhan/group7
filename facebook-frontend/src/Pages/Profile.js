                        ...
                        <Box className='leftSide' display='flex' alignItems='end'>
                            ...
                            <Box className='info'>
                                ...
                                <Box className='friendsPics'>
                                    <img src="https://di-uploads-pod19.dealerinspire.com/bentleyofaustin/uploads/2020/10/download.png" alt="frineds Pic" width="32px" height='32px' />
                                    <img src="https://logos-world.net/wp-content/uploads/2021/04/Porsche-Logo.png" alt="frineds Pic" width="32px" height='32px' />
                                    <img src="https://1000logos.net/wp-content/uploads/2018/03/Symbol-Lamborghini.jpg" alt="frineds Pic" width="32px" height='32px' />
                                </Box>
                            </Box>
                        </Box>
                    </Grid>
